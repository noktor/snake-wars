...
const UNIT_STATS = {
    [UNIT_TYPE.PEASANT]:  { hp: 30, damage: 3,  range: 1, speed: 4.0, costGold: 50,  costWood: 0,  trainTicks: 100, popCost: 1 },
    [UNIT_TYPE.FOOTMAN]:  { hp: 60, damage: 8,  range: 1, speed: 3.0, costGold: 100, costWood: 0,  trainTicks: 160, popCost: 1 },
    [UNIT_TYPE.ARCHER]:   { hp: 40, damage: 6,  range: 5, speed: 3.5, costGold: 50,  costWood: 50, trainTicks: 140, popCost: 1 }
}
...
const BUILDING_STATS = {
    ...
    [BUILDING_TYPE.BARRACKS]:  { hp: 400, costGold: 150, costWood: 100, buildTicks: 300, sizeX: 3, sizeY: 3 },
    [BUILDING_TYPE.FARM]:      { hp: 200, costGold: 50,  costWood: 100, buildTicks: 160, sizeX: 2, sizeY: 2 }
}
